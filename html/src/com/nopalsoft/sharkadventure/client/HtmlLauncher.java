package com.nopalsoft.sharkadventure.client;
...
public class HtmlLauncher extends GwtApplication implements RequestHandler, GoogleGameServicesHandler, FacebookHandler {

    @Override
    public GwtApplicationConfiguration getConfig() {
        return new GwtApplicationConfiguration(850, 510);
    }

    @Override
    public ApplicationListener createApplicationListener() {
        return new MainShark(this, this, this);
    }
